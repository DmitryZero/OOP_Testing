...
namespace Tests
{
    // 2)Новая заявка -> Оплата регистрации -> Регистрация -> Оплата первичной экспертизы -> Ожидание первичной экспертизы -> Ожидание завершения другого проекта -> Первичная Экспертиза -> Отклонено
    [TestClass]
    ...
    {        
        ...
        public void Run()
        {
            ...
            Assert.AreEqual(true, rospatent.experts.All(expert => expert.expertStatus == ExpertStatus.Busy));
