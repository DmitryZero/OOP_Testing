...
namespace Tests
{
    // 9) Новая заявка -> Оплата регистрации -> Регистрация -> Оплата первичной экспертизы -> Ожидание первичной экспертизы -> Первичная Экспертиза -> Одобрено -> Оплата вторичной экспертизы -> Ожидание вторичной экспертизы -> Ожидаем завершения другого проекта -> Вторичная экспертиза -> Одобрено
    [TestClass]
